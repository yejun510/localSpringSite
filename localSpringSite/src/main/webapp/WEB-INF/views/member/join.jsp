...
<!-- 모바일 웹 페이지 설정 -->
<link rel="shortcut icon" href="/resources/images/icon.png"/><!-- PDF는 Image인데 폴더 경로는 Images라서 바꿈 -->
		...
		<div class="well">
			<form id="memberForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					...
					class="col-sm-2 control-label">비밀번호 확인
					</label>
					<div class="col-sm-3">
						<input type="password"
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-6">
						...
						id="joinInsert" class="btn btn-default"/>
